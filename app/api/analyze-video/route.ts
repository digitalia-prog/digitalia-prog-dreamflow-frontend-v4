      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 rounded-2xl border border-white/10 bg-[#14121c] p-6">
          ...
          <p className="text-white/65">
            Colle un lien + le texte/script/transcript de la vidéo pour obtenir
            une analyse marketing complète, les angles utilisés et des idées à
            reproduire.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[420px_minmax(0,1fr)]">
            ...
            <div className="grid gap-4">
              ...
              <div className="space-y-2">
                <div className="text-sm text-white/80">
                  Offre / Produit analysé (optionnel)
                </div>
                <input
                  className={inputCls}
              ...
              <div className="space-y-2">
                <div className="text-sm text-white/80">
                  Texte / transcript / description de la vidéo
                </div>
                <textarea
                  className={textareaCls}
                  placeholder="Colle ici le hook, le script parlé, la description ou le transcript de la vidéo. Plus tu mets de contenu, meilleure sera l’analyse."
                  value={notes}
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Block title="Structure de la vidéo">
            ...
            <Block title="Prompt / brief pour recréer une vidéo similaire">
              <div className="whitespace-pre-wrap text-sm text-white/85">
                {result?.scriptPrompt || "-"}
              </div>
            </Block>
